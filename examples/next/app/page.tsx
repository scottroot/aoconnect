...
import { result } from "aoconnect-ts/browser";


export default async function Home() {
  let { Messages, Spawns, Output, Error } = await result({
    // the arweave TXID of the message
    message: "--b_aOVsZEezhq4gEcVdExBXOLu5VpRuxHtnIZQTi_w",
    // the arweave TXID of the process
    process: "-vsAs0-3xQw6QUAYbUuonTbXAnFNJtzqhriKKOymQ9w",
  });
  return (
